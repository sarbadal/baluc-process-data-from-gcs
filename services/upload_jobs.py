...
def upload_csv_content(
    ...
    return f"gs://{target_bucket}/{destination_path}"
...
class UploadJobManager:
    ...
    def _run_job(self, job_id: str, prepared_files: list[dict[str, str]], categories: list[str], file_types: list[str], upload_service: UploadService) -> None:
